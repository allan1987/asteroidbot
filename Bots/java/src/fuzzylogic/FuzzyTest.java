...
//	        }
        ...
        deltaXFromLeft.addTerm(new Triangle("HIGHT", -40.0, -50.0, -60.0));
        ...
        deltaYFromTop.addTerm(new Triangle("HIGHT", -4/0.0, -50.0, -60.0));
        ...
        sideThrustFront.addTerm(new Triangle("LOW", -1.0, 0.0, 1.0));
